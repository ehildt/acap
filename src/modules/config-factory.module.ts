...
import { ManagerRegistry } from '@/configs/manager/registry.dbs';
...
@Module({
  imports: [
    ConfigModule.forRoot({
      ...
      ignoreEnvFile: true,
      validationSchema,
      load: [AppConfigRegistry, MongoConfigRegistry, RedisConfigRegistry, ManagerRegistry, PublisherRegistry],
    }),
  ],
