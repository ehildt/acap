...
import { DeleteConfigIds, DeleteRealm, GetRealm } from '@/decorators/controller.method.decorators';
...
export class CachedRealmsController {
  ...
  @GetRealm()
  @OpenApi_GetRealm()
  async getRealmConfigIds(@QueryRealm() realm: string, @QueryConfigIds() configIds?: string[]) {
